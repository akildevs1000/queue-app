...
const Footer = ({ content = "Your Organization" }) => {
  return (
    ...
    <footer className="h-12 bottom-[30px] bg-surface-darker text-white flex items-center overflow-hidden relative z-30 border-t border-white/5 shadow-[0_-5px_15px_rgba(0,0,0,0.3)]">
