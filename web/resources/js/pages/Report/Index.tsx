...
export default function App({ services }: { services: any }) {
    ...
    const [selectedCounter, setSelectedCounter] = React.useState<string | null>(null);
    const [selectedStatus, setSelectedStatus] = React.useState<string | null>(null);
    const [selectedLangauge, setSelectedLangauge] = React.useState<string | null>(null);
    ...
    React.useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (selectedLangauge !== '-1') {
                    url.searchParams.append('language', selectedLangauge?.toString() || '');
                }

                ;

                // You can add filters here if needed
                // e.g. url.searchParams.append('service_id', serviceId);
        ...
        fetchData();
    }, [pagination.pageIndex, pagination.pageSize, selectedService, selectedCounter, selectedStatus, selectedLangauge]); // re-fetch on page or size change
    ...
    const handleLangaugeFilterChange = (language: any) => {
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex w-full items-center justify-between rounded-lg p-5">
                <div className="flex items-center gap-2">
                    ...
                    <Select onValueChange={handleLangaugeFilterChange}>
                        <SelectTrigger className="w-[180px]">
