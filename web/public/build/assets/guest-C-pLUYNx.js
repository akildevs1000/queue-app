import{r as o,j as e,K as k,m as y,L as N}from"./app-BWHm7pyg.js";import{C as S,a as g}from"./card-DT9nkP-u.js";import{c as w}from"./utils-jAU0Cazi.js";const E=({name:c="ABC Hospital",token_number_display:t,service:r,already_waiting_count:x,estimated_wait_time:l,date:d,time:a,code:i})=>(o.useEffect(()=>{},[]),e.jsxs(e.Fragment,{children:[e.jsx("style",{children:`@media print {
                    @page {
                        size: auto;
                        margin: 0;
                    }
