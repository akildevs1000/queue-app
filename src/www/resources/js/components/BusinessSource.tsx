        ...
        cell: ({ row }) => { // No handleDelete function here yet
            ...
            return (
                <div> {/* Adds right padding */}
                    ...
                    <Edit title={'Business Source'} endpoint={'business-sources'}  open={open} setOpen={setOpen} item={contact} />
...
export default function App({ items }: { items: any }) {
    ...
    const handlePerPage = (per_page: number) => {
        get(route("business-sources.index", { per_page }));
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full p-6 rounded-lg shadow flex justify-between items-center">
                ...
                <Create title={'Business Source'} endpoint={'business-sources'}  />
            </div>
