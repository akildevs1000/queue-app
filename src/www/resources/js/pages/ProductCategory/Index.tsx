        ...
        cell: ({ row }) => { // No handleDelete function here yet
            ...
            return (
                <div> {/* Adds right padding */}
                    ...
                    <Edit title={'Product Category'} endpoint={'product-categories'} open={open} setOpen={setOpen} item={contact} />
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="w-full p-6 rounded-lg shadow flex justify-between items-center">
                ...
                <Create title={'Product Category'} endpoint={'product-categories'} />
            </div>
